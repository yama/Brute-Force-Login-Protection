        ...
        <div class="postbox">
            ...
            <form method="post" action="options.php"> 
                ...
                <div class="inside">
                    ...
                    <p><label><input type="checkbox" name="bflp_inform_user" value="true" <?php echo ($this->__options['inform_user']) ? 'checked' : ''; ?> /> <strong><?php _e('Inform user about remaining login attempts on login page', 'brute-force-login-protection'); ?></strong></label></p>

                    <p><label><input type="checkbox" name="bflp_send_email" value="true" <?php echo ($this->__options['send_email']) ? 'checked' : ''; ?> /><strong><?php _e('Send email to administrator when an IP has been blocked', 'brute-force-login-protection'); ?></strong></label></p>
